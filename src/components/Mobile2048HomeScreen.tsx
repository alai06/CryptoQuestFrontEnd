import { BookOpen, Lightbulb, Wand2, Gamepad2, Trophy, HelpCircle, Menu } from 'lucide-react';
import { useState } from 'react';
import LanguageSelector from './LanguageSelector';
import { Language, getTranslations } from '../utils/translations';

interface Mobile2048HomeScreenProps {
...
export default function Mobile2048HomeScreen({ 
  onNavigate, 
  tutorialCompleted,
    ...
    <div className="min-h-screen bg-[#FBFBFD] flex flex-col">
      ...
      <div className="px-5 pt-8 pb-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-white rounded-xl p-4 text-center">
            ...
            <div className="text-[11px] text-[#86868B] font-bold uppercase tracking-wide">
      ...
      <div className="flex-1 px-5 pb-24">
          ...
          {modes.map((mode) => {
            ...
            return (
              <button
                ...
                className="relative bg-white rounded-2xl p-6 flex flex-col items-center justify-center gap-4 aspect-square active:scale-95 transition-transform"
                style={{ 
              ...
              >
                ...
                {/* Title */}
                <h3 
                  className="text-[18px] font-black text-center leading-tight"
                  style={{ color: mode.color }}
                >
                  {mode.title}
                </h3>
        ...
        <button
          ...
          className="w-full mt-3 bg-gradient-to-r from-[#00AFD7] to-[#007EA1] rounded-2xl p-5 flex items-center justify-between active:scale-[0.98] transition-transform"
          style={{ 
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <h3 className="text-[20px] font-black text-white leading-none mb-1">
                {t.modeProgress}
              </h3>
